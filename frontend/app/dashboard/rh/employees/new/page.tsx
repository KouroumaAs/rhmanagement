...
export default function NewEmployeePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Types qui ont un contrat (typeContrat, dateEmbauche, dateFinContrat)
    const hasContrat =
    ...
    try {
      ...
      if (
        formData.telephone &&
        !VALIDATION.PHONE_REGEX.test(formData.telephone)
      ) {
        setFieldErrors({
        ...
        toast({
          ...
          description:
            "Le numéro de téléphone n'est pas au format guinéen valide",
        });
      ...
      if (formData.dateNaissance) {
        ...
        if (age < 18) {
          ...
          toast({
            ...
            description:
              "La date de naissance est trop récente. L'employé doit avoir au moins 18 ans.",
            duration: 5000,
          });
          setIsSubmitting(false);
          return;
      ...
      if (
        ...
        setFieldErrors({
          dateFinContrat:
            "La date de fin est obligatoire pour les CDD et STAGE",
        });
        toast({
          variant: "destructive",
          title: "Erreur de validation",
          description:
            "La date de fin de contrat est obligatoire pour les CDD et les stages",
        });
        setIsSubmitting(false);
        return;
      }
      ...
      if (formData.dateFinContrat && formData.dateEmbauche) {
        ...
        if (dateFin <= dateDebut) {
          setFieldErrors({
            dateFinContrat:
              "La date de fin doit être supérieure à la date d'embauche",
          });
          toast({
            variant: "destructive",
            title: "Erreur de validation",
      ...
      console.log(
        "Test deja:",
        errorMessage.includes("deja") || errorFessage.includes("déjà"),
      );
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                {fieldErrors.dateNaissance ? (
                  ...
                  <p className="text-xs text-gray-500">
                    Facultatif - Âge minimum requis : 18 ans
                  </p>
                )}
              </div>
            </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-2">
                  ...
                  {fieldErrors.telephone ? (
                    ...
                    <p className="text-xs text-gray-500">
                      Format guinéen: doit commencer par 6 (Ex: 620 12 34 56 ou
                      +224 620 12 34 56)
                    </p>
                  )}
                </div>
          ...
          <Card className="shadow-xl border-0 bg-white">
            ...
            <CardContent className="p-6 space-y-5">
              ...
              {formData.typeEmploye !== "DNTT" &&
                formData.typeEmploye !== "DNTT_STAGIAIRE" && (
                  <div className="space-y-2">
                    <Label
                      htmlFor="profil"
                      className="text-sm font-semibold text-gray-700"
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, profil: e.target.value })
                      }
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Input
                      ...
                      placeholder={
                        getMatriculeNumberLength(formData.typeEmploye) === 2
                          ? "01, 02, 99..."
                          : "001, 002, 254..."
                      }
              ...
              {/* Type de contrat et dates - uniquement pour PERSONNEL_DSD et STAGIAIRE_DSD */}
              {(formData.typeEmploye === "PERSONNEL_DSD" ||
                formData.typeEmploye === "STAGIAIRE_DSD") && (
                  <>
                    <div className="space-y-2">
