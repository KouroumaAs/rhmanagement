...
"[project]/Desktop/rhmanagement/frontend/src/services/dashboard.service.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class DashboardService {
    async getStats() {
        ...
        try {
            var _badgesStatsResponse_data, _employeeStatsResponse_data;
            ...
            if (userRole === 'ADMIN') {
                try {
                    var _userStatsResponse_data;
                    const userStatsResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["get"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$src$2f$constants$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.STATS, {
                        headers: {
                            Authorization: "Bearer ".concat(token)
                        }
                    });
                    userStatsData = ((_userStatsResponse_data = userStatsResponse.data) === null || _userStatsResponse_data === void 0 ? void 0 : _userStatsResponse_data.data) || userStatsResponse.data;
                } catch (error) {
            ...
            const badgesStats = ((_badgesStatsResponse_data = badgesStatsResponse.data) === null || _badgesStatsResponse_data === void 0 ? void 0 : _badgesStatsResponse_data.data) || badgesStatsResponse.data || {
                total: 0,
                pending: 0,
                printed: 0,
                printedToday: 0
            ...
            const result = {
                success: true,
                data: {
                    employees: ((_employeeStatsResponse_data = employeeStatsResponse.data) === null || _employeeStatsResponse_data === void 0 ? void 0 : _employeeStatsResponse_data.data) || employeeStatsResponse.data,
                    users: userStatsData,
...
"[project]/Desktop/rhmanagement/frontend/app/dashboard/rh/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$src$2f$services$2f$dashboard$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/rhmanagement/frontend/src/services/dashboard.service.ts [app-client] (ecmascript)");
...
function DashboardRH() {
    ...
    const { logout, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    console.log('👤 User from context:', user);
    const [stats, setStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        totalEmployees: 0,
        activeEmployees: 0,
        personnelsDSD: 0,
        demarcheurs: 0,
    ...
    const [recentEmployees, setRecentEmployees] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [recentUsers, setRecentUsers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const fetchDashboardData = async ()=>{
        ...
        try {
            var _data_users, _data_employees, _byType_find, _byType_find1, _data_employees1, _data_employees2, _data_badges, _data_users1, _data_users2, _data_users3, _data_employees3, _data_users4;
            setIsLoading(true);
            console.log('⏳ isLoading set to true');
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$src$2f$services$2f$dashboard$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dashboardService"].getStats();
            console.log('✅ getStats response:', response);
            const data = response.data;
            console.log('Dashboard data:', data);
            console.log('Users data:', data.users);
            console.log('Recent users:', (_data_users = data.users) === null || _data_users === void 0 ? void 0 : _data_users.recent);
            // Calculate stats with safe defaults
            const byType = ((_data_employees = data.employees) === null || _data_employees === void 0 ? void 0 : _data_employees.byType) || [];
            const personnelsDSD = ((_byType_find = byType.find((t)=>t._id === 'PERSONNELS_DSD')) === null || _byType_find === void 0 ? void 0 : _byType_find.count) || 0;
            const demarcheurs = ((_byType_find1 = byType.find((t)=>t._id === 'DEMARCHEURS')) === null || _byType_find1 === void 0 ? void 0 : _byType_find1.count) || 0;
            // Calculate contracts expiring soon (30 days)
            const contractsExpiring = 0; // TODO: Implement logic
            setStats({
                totalEmployees: ((_data_employees1 = data.employees) === null || _data_employees1 === void 0 ? void 0 : _data_employees1.total) || 0,
                activeEmployees: ((_data_employees2 = data.employees) === null || _data_employees2 === void 0 ? void 0 : _data_employees2.active) || 0,
                personnelsDSD,
                demarcheurs,
                badgesEnAttente: ((_data_badges = data.badges) === null || _data_badges === void 0 ? void 0 : _data_badges.enAttente) || 0,
                contractsExpiring,
                totalUsers: ((_data_users1 = data.users) === null || _data_users1 === void 0 ? void 0 : _data_users1.total) || 0,
                activeUsers: ((_data_users2 = data.users) === null || _data_users2 === void 0 ? void 0 : _data_users2.active) || 0,
                inactiveUsers: ((_data_users3 = data.users) === null || _data_users3 === void 0 ? void 0 : _data_users3.inactive) || 0
            });
            // Limit to 2 most recent items
            setRecentEmployees((((_data_employees3 = data.employees) === null || _data_employees3 === void 0 ? void 0 : _data_employees3.recent) || []).slice(0, 2));
            setRecentUsers((((_data_users4 = data.users) === null || _data_users4 === void 0 ? void 0 : _data_users4.recent) || []).slice(0, 2));
        } catch (error) {
    ...
    const statsCards = [
        {
            ...
            change: "".concat(stats.activeEmployees, " actifs"),
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$users$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Users$3e$__["Users"],
            color: "text-[#ff8d13]",
        ...
        },
        {
            ...
            change: "".concat((stats.personnelsDSD / stats.totalEmployees * 100 || 0).toFixed(0), "% du total"),
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$building$2d$2$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Building2$3e$__["Building2"],
            color: "text-blue-600",
        ...
        },
        {
            ...
            change: "".concat((stats.demarcheurs / stats.totalEmployees * 100 || 0).toFixed(0), "% du total"),
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$trending$2d$up$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__TrendingUp$3e$__["TrendingUp"],
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        ...
                        children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                                    className: "text-gray-600",
                                                    children: "Les derniers enregistrements effectués"
                                                }, void 0, false, {
                                                    fileName: "[project]/Desktop/rhmanagement/frontend/app/dashboard/rh/page.tsx",
                                                    lineNumber: 254,
                                                    columnNumber: 17
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "space-y-3",
                                    children: recentEmployees.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "Aucun employé enregistré"
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/rhmanagement/frontend/app/dashboard/rh/page.tsx",
                                                lineNumber: 266,
                                                columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "Commencez par ajouter votre premier employé"
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/rhmanagement/frontend/app/dashboard/rh/page.tsx",
                                                lineNumber: 267,
                                                columnNumber: 19
                                        ...
                                        lineNumber: 264,
                                        columnNumber: 17
                                    }, this) : recentEmployees.map((employee)=>{
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$components$2f$ui$2f$avatar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Avatar"], {
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$components$2f$ui$2f$avatar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AvatarFallback"], {
                                                                ...
                                                                children: [
                                                                    (_employee_prenom = employee.prenom) === null || _employee_prenom === void 0 ? void 0 : _employee_prenom[0],
                                                                    (_employee_nom = employee.nom) === null || _employee_nom === void 0 ? void 0 : _employee_nom[0]
                                                                ]
                                                            }, void 0, true, {
                                                                fileName: "[project]/Desktop/rhmanagement/frontend/app/dashboard/rh/page.tsx",
                                                                lineNumber: 277,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "space-y-3",
                                            children: recentUsers.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$components$2f$ui$2f$avatar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Avatar"], {
                                                                    ...
                                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$components$2f$ui$2f$avatar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AvatarFallback"], {
                                                                        className: "bg-gradient-to-br from-[#ff8d13] to-[#ff8d13] text-white font-bold text-lg",
                                                                        children: [
                                                                            (_user_prenom = user.prenom) === null || _user_prenom === void 0 ? void 0 : _user_prenom[0],
                                                                            (_user_nom = user.nom) === null || _user_nom === void 0 ? void 0 : _user_nom[0]
                                                                        ]
                                                                    }, void 0, true, {
                                                                        fileName: "[project]/Desktop/rhmanagement/frontend/app/dashboard/rh/page.tsx",
                                                                        lineNumber: 389,
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                user.lastLogin && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    className: "text-sm text-gray-500 w-24 text-right font-medium",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "grid grid-cols-1 md:grid-cols-2 ".concat((user === null || user === void 0 ? void 0 : user.role) === 'ADMIN' ? 'lg:grid-cols-4' : 'lg:grid-cols-3', " gap-6"),
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                href: "/dashboard/rh/employees",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                children: "Voir et modifier la liste complète"
                                                            }, void 0, false, {
                                                                fileName: "[project]/Desktop/rhmanagement/frontend/app/dashboard/rh/page.tsx",
                                                                lineNumber: 432,
                                                                columnNumber: 21
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$rhmanagement$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                className: "text-sm font-normal text-white/90 mt-1",
                                                                children: "0 contrats à renouveler"
                                                            }, void 0, false, {
                                                                fileName: "[project]/Desktop/rhmanagement/frontend/app/dashboard/rh/page.tsx",
                                                                lineNumber: 468,
                                                                columnNumber: 21
...
_s(DashboardRH, "m6FyfsgP6w4P2526iriGpz62gyU=", false, function() {
    return [
...
_c = DashboardRH;
var _c;
__turbopack_context__.k.register(_c, "DashboardRH");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Desktop_rhmanagement_frontend_dc9d7f1c._.js.map